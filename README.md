...
диапазон(вместе со служебными) 10.10.10.0 - 10.10.10.8  
маска 255.255.255.248  

диапазон (вместе со служебными) 10.10.10.8 - 10.10.10.16  
маска 255.255.255.248  
...
диапазон (вместе со служебными) 10.10.10.248 - 10.10.10.256  
маска 255.255.255.248  
~~## UPD
Не понял что именно я не верно сделал.~~
## UPD  
Нам нужны подсети /29 это по 8 адресов, всего есть 256 адреса >>> 256/8=32  итого 32 подсети.
